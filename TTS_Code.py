...
apikey='2dMOrkSku_v8S5rlrLTwBIZwI4KgU1F1Qq26YEqxGv4Q'
url= 'https://api.us-south.text-to-speech.watson.cloud.ibm.com/instances/c86dcd2f-c323-49c7-a075-11329e809107'
...
with open('user_speech.mp3', 'wb') as audio_file:
    res = tts.synthesize(text, accept='audio/mp3', voice='en-US_LisaVoice').get_result()
